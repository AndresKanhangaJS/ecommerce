            ...
            <ul>
              <li class="mb-4">
                <label for="featured" class="flex items-center dark:text-gray-300">
                  <input id="featured" wire:model.live="featured" value="1" type="checkbox" class="w-4 h-4 mr-2">
                  <span class="text-lg dark:text-gray-400">Featured Products</span>
                </label>
              </li>
              <li class="mb-4">
                <label for="sale" class="flex items-center dark:text-gray-300">
                  <input id="sale" wire:model.live="sale" value="1" type="checkbox" class="w-4 h-4 mr-2">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
                <span class="font-semibold text-blue-500">
                    {{ Number::currency($price_range ?? $maxPrice, 'AOA') }}
                </span>
                ...
                <div class="flex justify-between">
                    <span class="inline-block text-lg font-bold text-blue-400">
                        {{ Number::currency(1000, 'AOA') }}
                    </span>
                    <span class="inline-block text-lg font-bold text-blue-400">
                        {{ Number::currency($maxPrice, 'AOA') }}
                    </span>
                </div>
            </div>
          </div>
          ...
          <div class="px-3 mb-4">
            <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
              <div class="flex items-center justify-between">
                <select wire:model.live="sort" name="" id="" class="block w-40 text-base bg-gray-100 cursor-pointer dark:text-gray-400 dark:bg-gray-900">
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
              <div class="border border-gray-300 dark:border-gray-700">
                ...
                <div class="p-3 ">
                  ...
                  <p class="text-lg ">
                    <span class="text-green-600 dark:text-green-600">{{Number::currency($product->price, 'AOA')}}</span>
                  </p>
                </div>

        ...
        <div class="p-4 sm:p-7">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="{{ route('login') }}">
                Sign in here
              </a>
            </p>
          </div>
          ...
          <div class="mt-5">
            ...
            @if (session('success'))
                <div class="bg-green-500 text-sm text-foreground-inverse rounded-lg p-4 mb-4" role="alert" tabindex="-1" aria-labelledby="hs-solid-color-danger-label">
                    <span id="hs-solid-color-danger-label" class="font-bold">{{session('success')}}</span>
                </div>
            @endif
